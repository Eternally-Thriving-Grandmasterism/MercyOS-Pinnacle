...
//! "Reptar on Ice" Rugrats-inspired quest mercy eternal supreme immaculate
//! Giant Reptar creature in ice biome, feed to tame, ride for joy/speed bonus philotic mercy
...
pub fn spawn_reptar_quest(
    ...
    if wonder_mode.get_single().is_ok() {
        // Spawn in ice biome mercy (placeholder near player)
        ...
        commands.spawn((
            ...
            Creature {
                creature_type: CreatureType::Deer,  // Reptar = giant deer mercy
