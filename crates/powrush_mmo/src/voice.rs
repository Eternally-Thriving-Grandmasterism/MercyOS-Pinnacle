...
//! Real-time microphone capture + hybrid PQC encrypted spatial 3D voice frames
//! ChaCha20Poly1305 stream over lightyear unreliable channel + position for HRTF spatial mercy eternal supreme ❤️🗣️🔐🌌
...
pub struct VoicePacket {
    ...
    pub nonce: [u8; 12],
    pub position: Vec3,  // Speaker position mercy
}
