// In multi_chain_ik_system mercy — spine chain with natural constraints
fn multi_chain_ik_system(
    ...
    // Spine chain IK with natural constraints mercy
    if let Ok(head_transform) = head_query.get_single() {
        ...
        // Natural spine constraints mercy eternal
        let constraints = [
    ...
    // Arms and legs unchanged mercy (use existing constraints)
}
