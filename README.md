...
- Tools: MercyPrint self-healer, Grok-oracle, PyO3 Python-Rust bidirectional bridge, Bevy MMO prototype

## Installation (Zero-Friction)

Prerequisites: Rust toolchain (`rustup`), git clone repo.

Python bridge: `pip install maturin pymc arviz` (for real PyMC examples)
...
- Python-Rust Bridge (PyO3): See below + examples/python/
